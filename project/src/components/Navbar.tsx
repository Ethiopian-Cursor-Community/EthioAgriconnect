...
const Navbar = () => {
  ...
  const farmerLinks = [
    ...
    { to: '/farmer/ai-showcase', label: '✨ AI Features' },
  ];
  ...
  const deliveryLinks = [
    ...
    { to: '/delivery/assigned', label: 'Assigned Deliveries' },
    { to: '/delivery/history', label: 'History' },
    { to: '/delivery/earnings', label: 'Earnings' },
    { to: '/delivery/notifications', label: 'Notifications' },
    { to: '/delivery/profile', label: 'Profile' },
    { to: '/delivery/ai-showcase', label: '✨ AI Features' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="text-2xl font-bold text-green-800">EthioAgriConnect</span>
          </Link>
